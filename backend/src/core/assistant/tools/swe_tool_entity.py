...
class SWEToolEntity(StatefulToolEntity):
    ...
    def _call(self, **kwargs):
        ...
        match self.current_stage.name:
            ...
            case "stage_4":
                return self._stage4(kwargs["action"],kwargs["focus_file_name"],kwargs["description"])
            case "stage_5":
                return self._stage5()
    ...
    def _stage3(self,focus_files_name_list: List[str]):
        ...
        return {"type": "success", "content": {"result": f"stage3 done,plan:\n{plans}"}}

    def _stage4(self,action:int,focus_file_name:str,description:str):
        ADD_PLAN = 0
        REMOVE_PLAN = 1
        MODIFY_PLAN = 2
        ...
        return {"type": "success", "content": {"result": f"stage4 done,plan :\n{plans}"}}
    ...
    def _stage5(self):
        ...
        return {"type": "success", "content": {"result": f"stage5 done,actions:\n{self.previous_action}"}}
